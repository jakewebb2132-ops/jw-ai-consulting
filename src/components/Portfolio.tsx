...
import ArrowUpRight from "phosphor-react/dist/icons/arrow-up-right";
import Bank from "phosphor-react/dist/icons/bank";
import Megaphone from "phosphor-react/dist/icons/megaphone";
import FilmStrip from "phosphor-react/dist/icons/film-strip";
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {caseStudies.map((study, index) => (
                        <div
                            key={index}
                            className={`group relative p-8 md:p-10 rounded-3xl bg-white/[0.02] border border-white/[0.05] backdrop-blur-xl transition-all duration-500 ${study.borderHover} hover:bg-white/[0.04] overflow-hidden flex flex-col h-full`}
                        >
